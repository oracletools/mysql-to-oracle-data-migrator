::Test name: MySQL_QueryDir Limit333
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239\test\v101\query\query_dir_mysql".Copy only 333 rows from MySQL query results into OracleTable table.
	::Arguments:
