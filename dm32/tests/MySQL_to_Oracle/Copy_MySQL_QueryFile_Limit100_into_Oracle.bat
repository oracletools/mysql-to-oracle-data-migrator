::Test name: MySQL_QueryFile Limit100
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239\test\v101\query\mysql_query.sql".Copy only 100 rows from MySQL query results into Oracle table.
	::Arguments:
